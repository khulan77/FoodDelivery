...
export const TableRangeSelector = <TData,>({ tableColumn }: TableRangeSelectorProps<TData>) => {
      ...
      <Popover>
        <PopoverTrigger asChild className="shadow-none">
          <Button
            id="date"
            variant={"outline"}
            className={cn("w-[300px] justify-start text-left font-normal rounded-full", !dateRange && "text-muted-foreground")}
          >
            <CalendarIcon />
